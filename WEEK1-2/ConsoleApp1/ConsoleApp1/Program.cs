...
//2.
Console.WriteLine("Please enter your first number here");
...
//3.
Console.WriteLine("We will divide your first number by the second number and give you a quotient and a remainder. Please enter the first number");
string firstNum = Console.ReadLine();

Console.WriteLine("Now please enter the second number, the one that you will divide the first number by");
string secondNum = Console.ReadLine();

int quotient = Convert.ToInt32(firstNum) / Convert.ToInt32(secondNum);
int remainder = Convert.ToInt32(firstNum) % Convert.ToInt32(secondNum);
